        ...
        public class ManagedToIL2CPP
        {
            public static Il2CppSystem.Object Serialize(object Data)
            {
                ...
                catch 
                {
                    ...
                    Extensions.Logger.LogError($"ManagedToIl2CPP: Not Implemented type: {Type.Name}");
                    return BinarySerializer.Serialize(Data);
                }
            }
            ...
            public static object Serialize(Il2CppSystem.Object Data)
            {
                ...
                if (Type.IsArray)
                {
                    if (Type.GetElementType().IsArray)
                    {
                        ...
                        if (Type.GetElementType().GetElementType() == Il2CppType.Of<nint>()) return BinarySerializer.Serialize(Data);
                        if (Type.GetElementType().GetElementType() == Il2CppType.Of<nuint>()) return BinarySerializer.Serialize(Data);
                ...
                else
                {
                    ...
                    if (Type == Il2CppType.Of<VRCPhotonEvent.EnumNPublicSealedvaAvFaUsStAlPrBi8vUnique>()) return Data.Unbox<VRCPhotonEvent.EnumNPublicSealedvaAvFaUsStAlPrBi8vUnique>();
                    if (Type == Il2CppType.Of<ParameterDictionary>()) return Data.Cast<ParameterDictionary>();
                ...
                Extensions.Logger.LogError($"Il2CPPToManaged: Not Implemented type: {Type.Name}");
                return BinarySerializer.Serialize(Data);
            }
