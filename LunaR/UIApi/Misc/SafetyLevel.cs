...
namespace LunaR.UIApi
{
    internal class SafetyLevel
    {
        ...
        public SafetyLevel(string safetyName, Color color, VRC.UserSocialClass socialClass, string description)
        {
            gameObject = Object.Instantiate(GameObject.Find("UserInterface/MenuContent/Screens/Settings_Safety/_Buttons_UserLevel/Button_Visitor"), GameObject.Find("UserInterface/MenuContent/Screens/Settings_Safety/_Buttons_UserLevel").transform);
