...
namespace Hexed.Hooking
{
    ...
    {
        private delegate void _SetAvatarEyeHeightByMultiplierDelegate(nint instance, nint __0, nint __1);
        private static _SetAvatarEyeHeightByMultiplierDelegate originalMethod;

        public void Initialize()
        {
            originalMethod = HookManager.Detour<_SetAvatarEyeHeightByMultiplierDelegate>(typeof(ExternVRCSDKBaseVRCPlayerApi).GetMethod(nameof(ExternVRCSDKBaseVRCPlayerApi.__SetAvatarEyeHeightByMultiplier__SystemSingle__SystemVoid)), Patch);
        }
